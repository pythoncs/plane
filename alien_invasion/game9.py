...
class Hero(object):
    ...
    def __init__(self, screen_temp):
        ...
        self.life = 21
        # self.life = 100
        self.image = pygame.image.load("./Runoob/images/life.png")
    ...
    def __create_images(self):
        #添加爆炸图片
        self.bomb_list.append(pygame.image.load("./Runoob/images/enemy1_down1.png."))
        self.bomb_list.append(pygame.image.load("./Runoob/images/enemy1_down2.png"))
        self.bomb_list.append(pygame.image.load("./Runoob/images/enemy2_down1.png"))
        self.bomb_list.append(pygame.image.load("./Runoob/images/enemy1_down4.png"))
...
class Bullet_Enemy(object):
    ...
    def __init__(self, screen_temp, x_temp, y_temp):
        self.x = x_temp + 25
        self.y = y_temp + 30
        self.image = pygame.image.load("./Runoob/images/bullet1.png")
        self.screen = screen_temp
...
class Bullet_Boss(object):
    ...
    def __init__(self, screen_temp, x_temp, y_temp):
        self.x = x_temp + 80
        self.y = y_temp + 230
        self.image = pygame.image.load("./Runoob/images/bullet2.png")
        self.screen = screen_temp
...
class Bullet_Boss1(object):
    ...
    def __init__(self, screen_temp, x_temp, y_temp):
        self.x = x_temp + 80
        self.y = y_temp + 230
        self.image = pygame.image.load("./Runoob/images/bomb.png")
        self.screen = screen_temp
...
class Bullet_Boss2(object):
    ...
    def __init__(self, screen_temp, x_temp, y_temp):
        self.x = x_temp + 80
        self.y = y_temp + 230
        self.image = pygame.image.load("./Runoob/images/bomb_supply.png")
        self.screen = screen_temp
...
class bomb_bullet(Base):
    #炸弹类
    def __init__(self, screen_temp):
        Base.__init__(self, screen_temp, random.randint(45, 400), 0, "./Runoob/images/bullet_supply.png")
...
class supply(Base):
    #补给类
    def __init__(self, screen_temp):
        Base.__init__(self, screen_temp, random.randint(45, 400), -300, "./Runoob/images/enemy1_down3.png")
...
class clear_bullet(Base):
    def __init__(self, screen_temp):
        Base.__init__(self, screen_temp, random.randint(45, 400), 0, "./Runoob/images/enemy2_down4.png")
        self.alive = False
...
class EnemyPlane(object):
    ...
    def __init__(self, screen_temp):
        ...
        self.y = 0
        self.image = pygame.image.load("./Runoob/images/enemy3_down2.png")
        self.screen = screen_temp
        self.bullet_list = []#用来存储子弹对象的引用
    ...
    def __create_images(self):
        self.bomb_list.append(pygame.image.load("./Runoob/images/enemy3_down1.png"))
        self.bomb_list.append(pygame.image.load("./Runoob/images/enemy3_down2.png"))
        self.bomb_list.append(pygame.image.load("./Runoob/images/enemy3_down3.png"))
        self.bomb_list.append(pygame.image.load("./Runoob/images/enemy3_down5.png"))
...
class Boss(EnemyPlane):
    ...
    def __init__(self,screen_temp):
        ...
        self.bomb_list = []
        self.__create_images()
        self.image = pygame.image.load("./Runoob/images/enemy2_down6.png")
        self.screen = screen_temp
        self.bullet_list = []
    ...
    def __create_images(self):
        ...
        self.bomb_list.append(pygame.image.load("./Runoob/images/enemy1_down1.png"))
        self.bomb_list.append(pygame.image.load("./Runoob/images/enemy2.png"))
        self.bomb_list.append(pygame.image.load("./Runoob/images/enemy2_hit.png"))
        self.bomb_list.append(pygame.image.load("./Runoob/images/enemy1.png"))
        self.bomb_list.append(pygame.image.load("./Runoob/images/bomb_supply.png"))
      #  self.bomb_list.append(pygame.image.load("./Runoob/images/life.png"))
       # self.bomb_list.append(pygame.image.load("./Runoob/images/life.png"))
...
def main():
    ...
    #                                 210,400
    background = pygame.image.load("./Runoob/images/background.png")
   # background = pygame.image.load("./Runoob/images/background.png")
    pygame.display.set_caption("飞机大战")
    atlas = pygame.image.load("./Runoob/images/life.png")
    #创建玩家飞机
    hero = Hero(screen)
    #创建敌机群
